...
| 収集ランナー（対象リポジトリに何も置かない計測。D-16） | 段階 1〜4 を実装（M-01 / M-02 / M-06〜M-10。手動実行と 15 分ごとの定期実行、PR の先頭も計測。M-02 は既定ブランチのみ。M-10 は対象アプリをランナー上で起動して検査。[収集ランナーで計測する](operations/collector.md)） |
