...
**Phase 2 の指標（M-02 / M-08 / M-09 / M-10）まで完了（2026-09-22）。**
...
| 正規化・判定エンジン | 完了（M-01 / M-02 / M-06 / M-07 / M-08 / M-09 / M-10 の 7 指標） |
...
- **残る指標** — M-03〜05 性能（`pact-verification` 形式のアダプタも未実装。Pact は JUnit XML で送れる）
